...
function lr_make_loader.make_loader_item(name, subgroup, order, tint)
  return{
    ...
    icons = {
      -- Base
      {
        icon = "__LoaderRedux_UltimateBelts__/graphics/icon/icon-loader-base.png",
        icon_size = 64,
        icon_mipmaps = 4,
      },
      -- Mask
      {
        icon = "__LoaderRedux_UltimateBelts__/graphics/icon/icon-loader-mask.png",
        icon_size = 64,
        icon_mipmaps = 4,
        tint = tint,
      },
...
function lr_make_loader.make_loader_entity(name, belt, tint, next_upgrade)
  ...
  loader.structure.front_patch = {
    sheet = {
      filename= "__LoaderRedux_UltimateBelts__/graphics/entity/loader-front-patch.png",
      priority = "extra-high",
      width = 94,
      height = 79,
      shift = util.by_pixel(10, 2),
      hr_version = {
        filename= "__LoaderRedux_UltimateBelts__/graphics/entity/hr-loader-front-patch.png",
        priority = "extra-high",
        width = 186,
        height = 155,
  ...
  loader.structure.direction_in = {
    sheets = {
      -- Base
      {
        filename= "__LoaderRedux_UltimateBelts__/graphics/entity/loader-base.png",
        priority = "extra-high",
        width = 94,
        height = 79,
        shift = util.by_pixel(10, 2),
        hr_version = {
          filename= "__LoaderRedux_UltimateBelts__/graphics/entity/hr-loader-base.png",
          priority = "extra-high",
          width = 186,
          height = 155,
          shift = util.by_pixel(9.5, 1.5),
      ...
      -- Mask
      {
        filename= "__LoaderRedux_UltimateBelts__/graphics/entity/loader-mask.png",
        priority = "extra-high",
        width = 94,
        height = 79,
        shift = util.by_pixel(10, 2),
        tint = tint,
        hr_version = {
          filename= "__LoaderRedux_UltimateBelts__/graphics/entity/hr-loader-mask.png",
          priority = "extra-high",
          width = 186,
          height = 155,
          shift = util.by_pixel(9.5, 1.5),
      ...
      -- Shadow
      {
        filename= "__LoaderRedux_UltimateBelts__/graphics/entity/loader-shadow.png",
        priority = "extra-high",
        width = 94,
        height = 79,
        shift = util.by_pixel(10, 2),
        draw_as_shadow = true,
        hr_version = {
          filename= "__LoaderRedux_UltimateBelts__/graphics/entity/hr-loader-shadow.png",
          priority = "extra-high",
          width = 186,
          height = 155,
          shift = util.by_pixel(9.5, 1.5),
      ...
      -- Lights
      {
        filename= "__LoaderRedux_UltimateBelts__/graphics/entity/loader-lights.png",
        priority = "extra-high",
        width = 94,
        height = 79,
        shift = util.by_pixel(10, 2),
        draw_as_light = true,
        hr_version = {
          filename= "__LoaderRedux_UltimateBelts__/graphics/entity/hr-loader-lights.png",
          priority = "extra-high",
          width = 186,
          height = 155,
          shift = util.by_pixel(9.5, 1.5),
